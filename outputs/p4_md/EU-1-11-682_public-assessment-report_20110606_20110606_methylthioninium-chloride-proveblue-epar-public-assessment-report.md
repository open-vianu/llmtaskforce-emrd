...
Some complementary studies have been performed to bridge to the reference product
...
support the application (data not shown). ***Safety pharmacology programme ***
...
toxicological profile to the reference medicinal product. ***Single dose toxicity ***
...
least 15 mg/kg in sheep in therapy of severe methaemoglobinaemias (Burrows 1984). ***Repeat dose toxicity ***
...
|Member State|Total number of cases|Cause of Poisoning (number of cases)|Antidote used (manufacturer)|Protocol of MB treatment|
|---|---|---|---|---|
|Czech Republic|32 cases since 2004|- Gentian violet (22)|Ascorbic acid only|Adults and children: 1-2 mg/kg IV (1% solution) over 5 min. Repeat dose in 30- 60 min if no response.|
|||- Aniline (5)|1 case: Toluidin blue (unknown) 4 cases: no treatment||
|||- Dapsone (2)|Not specified||
|||- Ortho-toluidine (1)|Not specified||
|||- Isobutylnitrite (Poppers) (2)|1 case: Toluidin blue (unknown)||
...
|Hungary|No information in the database||||
...
solution for injection to avoid local pain, in particular in paediatric population. ***Medicinal-product induced methaemoglobinaemia – Case reports ***
...
|Kane 2007|Benzocaine|18 patients (mean age: 62.8 ± 16.0 years)|Mean dose ± SD: 1.3 ± 0.4 mg/kg body weight (range 0.7-2 mg/kg) 2 patients required a 2nd dose (after initial dose of 50 mg)|IV|Resolution of signs and symptoms within 1h (frequently within 20 to 30 min)|
...
|Reference|Cause|Patient|Col4|MB Treatment|Route|Results|
|---|---|---|---|---|---|---|
...
|Cause : Antibiotics|||||||
|Ferguson 1997|Dapsone (deliberate self- poisoning)||14-year-old girl|1st dose: 90 mg Total dose over 48h: 8 mg/kg|IV bolus|1h after 1st dose, MetHb level: 5.9% but rapid increase of MetHb level (exceeding 25%). MetHb level reduces over|


-----

|Col1|Col2|Col3|Col4|Col5|next 4-5 days after total dose of 8 mg/mL MB.|
|---|---|---|---|---|---|
...
|Ferrer- Gomez 2008|Aniline|19-year-old man|1st dose: 80 mg over 10 min 2nd dose: 1 mg/kg 3rd dose: not specified Total dose: 3 mg/kg|IV|Improvement|
|Kearney 1984|Aniline|32-year-old man|- 200 mg (plus 500 mg ascorbic acid) - 2nd dose: 300 mg (plus 1g ascorbic acid) - Over the next 12h: 800 mg (plus 2.5 g ascorbic acid) in 5 divided dose - 20h after poisoning occurred, 180 mg|IV|Reduction of the MetHb level from 70% to 24%. Then MetHb level declined spontaneously. Patient scheduled for quantitative G6PD studies but lost to follow-up.|
...
|Harvey 1983|Aniline|22-year-old man|- 1st dose: 150 mg (2 mg/kg) - 2nd dose: 150 mg|IV|Reduction of MetHb level|
...
|Geiger 1935|Cyanide poisoning|28-year-old woman|1st dose: 50 cm3 (1% solution) 2nd dose (50 cm3 of 1% solution) administered 10 min after the 1st one|IV|Within 8 min after the 1st injection, respiratory function restored. Definite improvement 30 min after 2nd dose.|
...
|Col1|Col2|therefore be considered and total cumulative dose should not exceed 4 mg/kg. An appropriate warning is included in the PIL.|
|---|---|---|
...
|Col1|Col2|Section 4.6 also advises breast-feeding to be discontinued for up to 6 days after treatment with Methylthioninium chloride Proveblue. Corresponding advice as appropriate is also clearly communicated within the PIL.|
|---|---|---|
...
|Col1|Col2|Col3|the product name to ensure healthcare professionals will not accidentally administer the product, resulting in overdose.|
|---|---|---|---|
...
the last 70 years has demonstrated its efficacy to reverse most cases of induced
...
population. **Benefit-risk balance **
...
should also be applicable to Methylthioninium chloride Proveblue. **2.8.2. Risk management plan **
...
information ***2.9. Recommendation ***
