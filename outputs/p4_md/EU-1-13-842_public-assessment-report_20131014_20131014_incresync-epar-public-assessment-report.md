...
##### 2.1. Introduction......................................................................................................... 9 2.2. Quality aspects .................................................................................................. 10 2.2.1. Introduction .................................................................................................... 10 2.2.2. Active Substance Pioglitazone ........................................................................... 11 2.2.3. Active Substance Alogliptin ............................................................................... 12 2.2.4. Finished Medicinal Product ................................................................................ 15 2.2.5. Discussion on chemical, pharmaceutical and biological aspects .............................. 18 2.2.6. Conclusions on the chemical, pharmaceutical and biological aspects ...................... 18 2.2.7. Recommendation for future quality development ................................................. 18 2.3. Non-clinical aspects ............................................................................................ 18 2.3.1. Introduction .................................................................................................... 18 2.3.2. Pharmacology ................................................................................................. 19 2.3.3. Pharmacokinetics............................................................................................. 25 2.3.4. Toxicology ...................................................................................................... 34 2.3.5. Ecotoxicity/environmental risk assessment ......................................................... 45 2.3.6. Discussion on non-clinical aspects...................................................................... 48 2.3.7. Conclusion on the non-clinical aspects ................................................................ 54 2.4. Clinical aspects .................................................................................................. 54 2.4.1. Introduction .................................................................................................... 54 2.4.2. Pharmacokinetics............................................................................................. 57 2.4.3. Pharmacodynamics .......................................................................................... 65 2.4.4. Discussion on clinical pharmacology ................................................................... 67 2.4.5. Conclusions on clinical pharmacology ................................................................. 70 2.5. Clinical efficacy .................................................................................................. 70 2.5.1. Dose response study ........................................................................................ 73 2.5.2. Main studies ................................................................................................... 74 2.5.3. Discussion on clinical efficacy ............................................................................ 88 2.5.4. Conclusions on the clinical efficacy ..................................................................... 90 2.6. Clinical safety .................................................................................................... 90 2.6.1. Discussion on clinical safety ............................................................................ 115 2.6.2. Conclusions on the clinical safety ..................................................................... 120 2.7. Pharmacovigilance ............................................................................................ 120 2.8. Risk Management Plan ...................................................................................... 120 2.9. User consultation ............................................................................................. 126
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 41/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 42/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 43/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 44/136
...
***Pioglitazone/Alogliptin in combination with pioglitazo*** ***ne***
...
**Calculation of PEC** **surface water**

*DOSE* ai  *F* pen
*PEC* SW  *WASTEW* inhab  *DILUTION*

CHMP assessment report
EMA/CHMP/208477/2013 Page 45/136

|Parameter|Substance|Study ID/GLP|Protocol|Results|Criteria|Conclusion|
|---|---|---|---|---|---|---|
|Bioaccumulation|alogliptin|[1]/N|pH metric method|log K 0.6 ow|log K > ow 4.5|not B|


-----

*DOSE* ai = 25 (mg alogliptin patient [-1] d [-1] )
*DOSE* ai = 1560 (mg metformin patient [-1] d [-1] )
...
The applicant has used the default *F* pen of 0.01. The resulting *PEC* sw is 0.125 µg alogliptin/L. Based
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 46/136
...
|PEC , default or refined surfacewater (e.g. prevalence, literature)|0.125|µg/L|> 0.01 threshold|
|Other concerns (e.g. chemical class)|not investigated||(Y/N)|


-----

|Phase II Physical-chemical properties and fate|Col2|Col3|Col4|Col5|Col6|
|---|---|---|---|---|---|
|Study type|Test protocol|Results|||Remarks|
|Adsorption-Desorption|OECD 106|K = 25.2 and 18.7 L/kg oc|||two sludges|
||OECD 106|PM||||
|Ready Biodegradability Test|OECD 301|not readily biodegradable||||
|Aerobic and Anaerobic Transformation in Aquatic Sediment systems|OECD 308|DT = 1.8 and 6.9 d 50, water DT = >100 d 50, sediment DT = >100 d 50, whole system % shifting to sediment = 84 and 86%|||all values determined at 20°C|
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 47/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 48/136
...
C max . CYP induction by alogliptin is not found *in vitro* or *in vivo* .
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 49/136
...
T 1/2 of the parent compound in plasma varies between 2 to 5 hours in animals as compared with 5
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 51/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 52/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 53/136
...
effect study with the sediment dwelling organism should be compared to the PEC sediment .
...
- a Kow study for alogliptin ***2.4. Clinical aspects *** **2.4.1. Introduction **
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 54/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 55/136


-----

##### **Table 1 Overview of Alo g li p tin Phase 1 and 2 Clinical Pharmacolo gy Studies **

**Stud** **y** **Number** **(** **Countr** **y)** **Descri** **p** **tion** **(** **a** **)**
...
008 Population PK Report Population pharmacokinetic analysis in an efficacy and safety study of alogliptin in subjects
(multinational) with T2DM (phase 3)
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 56/136


-----

##### **Table 2 Alo g li p tin Main and Su pp ortive Phase III Studies b y Indication **
...
Add-on to MET and TZD 009, 322OPI-004, 322OPI-001
...
had been reached; a final study report of study 402 is expected to be available in the first quarter of 2014. **2.4.2. Pharmacokinetics **
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 57/136
...
No statistically significant differences for the median T max values for either alogliptin or pioglitazone

were observed between the A12.5+P15 BL tablet, and individual alogliptin 12.5 mg and

pioglitazone 15 mg tablets.
##### **Table 3 Pharmacokinetic Parameters of Alogliptin and Pioglitazone ** **Following Administration of an A12.5+P15 BL Tablet and Individual Alogliptin ** **12.5 m g and Pio g litazone 15 m g Tablets: Stud y 322OPI-101 ** **LS Mean ** Analyte (matrix) Alogliptin 12.5 mg + Ratio T/R  100 **Parameter (units) N A12.5+P15 BL (T) Pioglitazone 15 mg (R) (90% CI) (a) ** **Alogliptin (Plasma) ** AUC(0-tlqc) (ng∙hr/mL) 68 826.83 824.23 100.32 (99.00, 101.65) AUC(0-inf) (ng∙hr/mL) 66 904.72 904.17 100.06, (98.68, 101.46) Cmax (ng/mL) 68 48.23 50.28 95.94 (91.83, 100.23) Tmax (hr) (b,c) 68 3.00 2.99 N/A **Pioglitazone (Serum) ** AUC(0-tlqc) (ng∙hr/mL) 68 5707.70 5774.19 98.85 (95.42, 102.40) AUC(0-inf) (ng∙hr/mL) 59 6399.01 6429.75 99.52 (96.58, 102.55) Cmax (ng/mL) 68 612.22 626.25 97.76 (91.82, 104.08) Tmax (hr) (b,d) 68 1.77 1.50 N/A
...
##### **Table 4 Pharmacokinetic Parameters of Alogliptin and Pioglitazone ** **Following Administration of an A25+P45 BL Tablet and Individual Alogliptin 25 ** **m g and Pio g litazone 45 m g Tablets: Stud y 322OPI-101 ** **LS Mean ** Analyte (matrix) Alogliptin 25 mg + Ratio T/R  100 **Parameter (units) N A25+P45 BL (T) Pioglitazone 45 mg (R) (90% CI) (a) ** **Alogliptin (Plasma) ** AUC(0-tlqc) (ng∙hr/mL) 67 1582.33 1601.99 98.77 (97.58, 99.98) AUC(0-inf) (ng∙hr/mL) 66 1694.76 1719.46 98.56 (97.40, 99.74) Cmax (ng/mL) 68 104.10 106.15 98.07 (93.33, 103.06) Tmax (hr) (b,c) 68 2.50 2.98 N/A **Pioglitazone (Serum) ** AUC(0-tlqc) (ng∙hr/mL) 67 14978.78 14369.87 104.24 (98.62, 110.18) AUC(0-inf) (ng∙hr/mL) 47 16789.67 15961.30 105.19 (98.19, 112.69) Cmax (ng/mL) 68 1276.53 1303.92 97.90 (89.34, 107.28) Tmax (hr) (b,d) 68 3.00 2.00 N/A
...
shown. In all cases the 90% CI of the AUC and C max was within the 80%-125% range.
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 59/136


-----

##### **Table 5 Pharmacokinetic Parameters of Alogliptin and Pioglitazone When ** **Administered as an A25+P45 BL Tablet Under Fed and Fasted Conditions: Study ** **322OPI-006 ** **LS Mean ** Analyte (matrix) N N A25+P45 BL A25+P45 BL Ratio T/R  100 **Parameter (units) (T) (R) Fed (T) Fasted (R) (90% CI) (a) ** **Alogliptin (plasma) ** AUC(0-tlqc) (ng  hr/mL) 23 23 1508.08 1484.57 101.58 (99.02, 104.21 AUC(0-inf) (ng  hr/mL) 23 23 1630.19 1607.20 101.43 (99.05, 103.87 Cmax (ng/mL) 23 23 104.44 94.77 110.21 (101.61, 119.54) Tmax (hr) (b,c) 23 23 3.00 2.00 N/A **Pioglitazone (serum) ** AUC(0-tlqc) (ng  hr/mL) 23 23 14493.66 14561.85 99.53 (90.87, 109.02 AUC(0-inf) (ng  hr/mL) 20 19 15210.31 15696.40 96.90 (87.05, 107.87 Cmax (ng/mL) 23 23 1531.59 1478.31 103.60 (90.49, 118.61 Tmax (hr) (b,d) 23 23 4.00 2.00 N/A
...
C max of alogliptin and of pioglitazone were within the 80% to 125%. This was supported by food
...
pioglitazone metabolites were observed. ***Pharmacokinetics of alogliptin ***
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 60/136
...
Alogliptin is absorbed rapidly with median time to reach C max (T max ) occurring approximately 1-2
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 61/136
...
The intrasubject variability was (<23% for C max and AUC values).
...
Peak exposure (C max ) to alogliptin was approximately 13%, 42%, 27%, and 32% greater in
...
in healthy subjects. No significant differences in T max for any of the renal impairment groups vs the
...
Hepatic impairment: No clinical significant differences in AUC and peak C max exposure to alogliptin
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 62/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 63/136


-----

distribution of [ [14] C]pioglitazone into human red blood cells was minimal. Pioglitazone and all active
...
urine [45% of the recovered label]). The mean serum T 1/2 of unchanged pioglitazone is 5 to 6 hours,

and the mean serum T 1/2 for its total active metabolites is 16 to 23 hours.

**Intrinsic factors**

Total exposure AUC (0 inf) to pioglitazone was approximately 20% higher in elderly (≥65 years of age)

subjects than in young subjects (≤50 years of age). Mean AUC and C max values for pioglitazone and
...
Peak exposure (C max ) to pioglitazone was 18% and 38% lower in subjects with moderate and severe
...
C max values of pioglitazone in subjects with hepatic impairment were approximately 50% of those of
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 64/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 65/136
...
mg), with median Tmax of 1.00 to 1.25 hours [CPH-001]. E max and T max for the placebo group were
...
Following multiple-dose administration in healthy Japanese subjects [CPH-002], E max was >95% for

all dose groups (25, 50, and 100 mg), with Tmax of 1 hour on both Day 1 and after 7 days of

once-daily dosing (Day 7). E max and T max for the placebo group were 3.8% and 15 hours,
...
Following multiple-dose administration in subjects with T2DM (002), E max was >93% for all dose

groups (25, 100, and 400 mg), with T max of approximately 1 hour on Day 1 and 1 to 2.5 hours after

14 days of once-daily dosing (Day 14). E max and T max for the placebo group were 25.3% and 1.5
...
with an E max pharmacodynamic model confirmed the potency of alogliptin as an inhibitor of DPP-4

activity with a predicted E max value of 96.2% and a predicted EC50 value of 3.73 ng/mL in healthy

subjects in *study 001* and a predicted E max of 98.9% and a predicted EC50 value of 6.55 ng/mL in
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 66/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 67/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 68/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 69/136
...
Pharmacokinetics and pharmacodynamics were sufficiently investigated in the view of the CHMP. ***2.5. Clinical efficacy ***
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 70/136
...
**Stud** **y** **Desi** **g** **n** **,** **Ke** **y** **Inclusion Criteria** **,** **and Primar** **y** **End** **p** **oint** **N** **Treatment**
**Phase 2** **S** **tud** **y**
003 12-week, multicenter, randomized, double-blind, 265 A6.25, A12.5, A25, A50, A100
Dose-ranging placebo-controlled study in T2DM subjects on diet and exercise or Placebo once daily

alone, or monotherapy with SU/MET, or a combination of SU Randomization ratio:
and MET. 1:1:1:1:1:1
Age: 18 to 75 years; HbA1c: 6.8% to 11.0%.
Change from baseline in HbA1c at Week 12.

**Main Phase III** **,** **26-Week** **,** **Placebo-Controlled Studies**
010 26-week, multicenter, randomized, double-blind, 329 A12.5 once daily or
Monotherapy placebo-controlled, parallel-group study, in T2DM subjects on A25 once daily or

diet and exercise alone. Placebo once daily
Age: 18 to 80 years; HbA1c 7.0% to 10.0%. Randomization ratio: 2:2:1
Chan g e from baseline in HbA1c at Week 26.

009 26-week, multicenter, randomized, double-blind, 493 (b) A12.5 once daily or
Add-on to TZD, placebo-controlled, parallel-group study, in T2DM subjects on A25 once daily or
with or without TZD (pioglitazone or rosiglitazone), with or without MET or Placebo once daily
MET or SU SU. Randomization ratio: 2:2:1

Age: 18 to 80 years; HbA1c: 7.0% to 10.0%.
Chan g e from baseline in HbA1c at Week 26.

**Main Phase III** **,** **Lon** **g** **-Term** **,** **Active-** **C** **om** **p** **arator** **S** **tudies**
322OPI-004 52-week, multicenter, randomized, double-blind, 803 A25+P30 once daily or
Add-on to active-comparator (A25 vs titrating pioglitazone from 30 to 45 P45 once daily (titrated from
PIO/MET mg) study in T2DM subjects on combination pioglitazone P30)

30 mg and MET ≥1500 mg (or MTD). Randomization ratio: 1:1
Age: 18 to 80 years; HbA1c: 7.0% to 10.0%.
Change from baseline in HbA1c at Weeks 26 and 52.

**S** **u** **pp** **ortive Phase III** **S** **tudies**
322OPI-001 26-week, multicenter, randomized, double-blind, 1554 Placebo+placebo once daily or
Combination placebo-controlled, 12-arm, factorial study evaluating A12.5+placebo once daily or
ALO/PIO alogliptin alone, pioglitazone alone and alogliptin/pioglitazone A25+placebo once daily or
add-on to MET in combination, in T2DM subjects on MET monotherapy P15+placebo once daily or

≥1500 mg (or MTD). P30+placebo once daily or
Age: 18 to 80 years, HbA1c: 7.5% to 10.0%. P45+placebo once daily or
Change from baseline in HbA1c at Week 26. A12.5+P15 once daily or
...
322OPI-002 26-week, multicenter, randomized, double-blind, 655 A12.5+P30 once daily or
Initial placebo-controlled, 4-arm, study evaluating alogliptin alone, A25+P30 once daily or
combination pioglitazone alone and alogliptin/pioglitazone in combination, A25+placebo once daily or
ALO/PIO in T2DM subjects on diet and exercise alone. P30+placebo once daily

Age: 18 to 80 years; HbA1c: 7.5% to 11.0%. Randomization ratio: 1:1:1:1
Chan g e from baseline in HbA1c at Week 26.

CHMP assessment report
EMA/CHMP/208477/2013 Page 71/136


-----

##### **Table 7 Overview other p hase 3 alo g li p tin studies**

**Stud** **y** **Desi** **g** **n** **,** **Ke** **y** **Inclusion Criteria** **,** **and Primar** **y** **End** **p** **oint** **N** **Treatment**
007 26-week, multicenter, randomized, double-blind, 500 A12.5 once daily or
Add-on to SU placebo-controlled, parallel-group study, in T2DM subjects on A25 once daily or

SU monotherapy (≥10 mg or maximum tolerated dose [MTD] Placebo once daily
of glyburide). Randomization ratio: 2:2:1
Age: 18 to 80 years; HbA1c: 7.0% to 10.0%.
Chan g e from baseline in HbA1c at Week 26.

008 26-week, multicenter, randomized, double-blind, 527 A12.5 once daily or
Add-on to MET placebo-controlled, parallel-group study, in T2DM subjects on A25 once daily or

MET monotherapy (≥1500 mg or MTD). Placebo once daily
Age: 18 to 80 years; HbA1c: 7.0% to 10.0%. Randomization ratio: 2:2:1
Chan g e from baseline in HbA1c at Week 26.

11 26-week, multicenter, randomized, double-blind, 390 A12.5 once daily or
Add-on to placebo-controlled, parallel-group study, in T2DM subjects on A25 once daily or
insulin, with or insulin with or without MET. Placebo once daily
without MET Age: 18 to 80 years; HbA1c: ≥8.0%. Randomization ratio: 1:1:1

Chan g e from baseline in HbA1c at Week 26.

**Main Phase III** **,** **Lon** **g** **-Term** **,** **Active-** **C** **om** **p** **arator** **S** **tudies**
305 (a) 2-year, multicenter, randomized, double-blind, active 2638 A12.5 once daily or
Add-on to MET comparator (alogliptin vs SU) study in T2DM subjects on MET A25 once daily or

≥1500 mg (or MTD) alone. Glipizide 5–20 mg (titrated)
Age: 18 to 80 years; HbA1c: 7.0% to 9.0%. Randomization ratio: 1:1:1
Chan g e from baseline in HbA1c at Weeks 52 and 104.

**Su** **pp** **ortive Phase III Studies**
302 26-week, multicenter, randomized, double-blind, 784 Placebo BID or
Initial placebo-controlled, 7-arm, factorial study evaluating alogliptin A25 once daily or
combination alone, MET alone or alogliptin/MET in combination, in T2DM A12.5 BID or
ALO/MET subjects on diet and exercise alone. M500 BID or

Age: 18 to 80 years; HbA1c: 7.5% to 10.0%. M1000 BID or
Change from baseline in HbA1c at Week 26. A12.5+MET500, BID or
...
**O** **ther** **S** **u** **pp** **ortive Phase III** **S** **tudies**
303 52-week, multicenter, randomized, double-blind, 441 A25 once daily or
Elderly active-comparator (alogliptin vs SU) study in elderly T2DM Glipizide 5 mg once daily

subjects. (titrated to 10 mg for
Age: 65 to 90 years. HbA1c: 6.5% to 9.0% if on diet and inadequate control)
exercise Alone; 6.5% to 8.0% if on oral monotherapy. Randomization ratio: 1:1
Chan g e from baseline in HbA1c at Week 52.

402 (a) ~4.75-year, multicenter, randomized, double-blind, 2134 In addition to Standard of Care
CV outcomes placebo-controlled, CV outcomes study in subjects with T2DM (interim) antidiabetic medications:

and recent ACS (within 15–90 days). ~5400 A25 once daily (6.25 and
Age: ≥18 years of age; HbA1c: 6.5% to 11.0% if antidiabetic (planned) 12.5 mg dose available for
regimen includes oral monotherapy or oral combination severe and moderate renal
therapy; 7.0% to 11.0% if antidiabetic regimen includes insulin. impairment) or Placebo once
MACE composite (CV death, nonfatal MI, nonfatal stroke). daily

Randomization ratio: 1:1

**S** **tud** **y** **Desi** **g** **n** **,** **Ke** **y** **Inclusion** **C** **riteria** **,** **and Primar** **y** **End** **p** **oint** **N** **Treatment**
**O** **ther** **S** **u** **pp** **ortive Phase III** **S** **tudies** **(** **continued** **)**
012 4-year, multicenter, open-label extension study. 3323 A12.5 once daily or
Open-label Subjects rolled over from Studies 010, 007, 008, 009, 011, A25 once daily
extension 322OPI-001, and 322OPI-002. Randomization ratio: 1:1

Safet y .

301 16-week, multicenter, randomized, double-blind, active- and 71 A25 once daily
Postprandial placebo-controlled study in T2DM subjects on diet and exercise A25+P30 once daily
lipids or treatment with MET, SU, nateglinide, or repaglinide. Placebo once daily

Age: 18 to 70 years; HbA1c: 6.5% to 9.0%. Randomization ratio: 1:1:1
Chan g e from baseline in p ost p randial incremental area under

CHMP assessment report
EMA/CHMP/208477/2013 Page 72/136
...
alogliptin 6.25 mg, which is likely due to lack of optimal DPP-4 inhibition. **Table 8 Change From baseline in HbA1c (%) and FPG (mmol/L) Levels on Day 85 **

**(** **ITT** **,** **LOCF** **)** **(** **003** **)**

**Placebo** **A6.25** **A12.5** **A25** **A50** **A100**

**(N=41)** **(N=42)** **(N=42)** **(N=45)** **(N=43)** **(N=44)**

**baseline HbA1c**

Mean (SD) 8.24 7.99 7.87 8.02 8.11 8.00
(1.034) (1.006) (0.905) (0.978) (1.037) (0.988)

LS Mean Change from baseline -0.01 -0.19 -0.54* -0.56* -0.44* -0.51*
at Day 85 (SE) (a) (0.123) (0.121) (0.122) (0.117) (0.124) (0.119)

**baseline FPG**

Mean (SD) 10.5 10.6 9.6 10.6 10.1 10.5
(2.80) (2.73) (2.27) (3.47) (2.89) (3.14)

LS Mean Change from baseline -1.3 -0.9 -0.8 -2.0* -1.4* -1.6*
at Day 85 (SE) (a) (0.39) (0.50) (0.50) (0.49) (0.51) (0.49)
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 73/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 74/136
...
characteristic.
##### **Table 9 Sub j ect Demo g ra p hics and baseline Characteristics ( studies 010, 009 )**

CHMP assessment report
EMA/CHMP/208477/2013 Page 75/136

|Study 010 Monotherapy Placebo A12.5 A25 Category N=65 N=133 N=131|Study 009 Add-on to TZD, with or without MET or SU|
|---|---|
||Placebo A12.5 A25 N=97 N=197 N=199|
|Sex, n (%) Men 33 (50.8) 65 (48.9) 77 (58.8) Women 32 (49.2) 68 (51.1) 54 (41.2) Age (years) Mean (SD) 53.8 (10.99) 52.6 (12.01) 54.2 (10.16) Min, Max 35, 80 24, 77 31, 80 BMI Mean (SD) 32.17 (5.748) 31.82 (5.166) 32.16 (5.915) HbA1c|53 (54.6) 109 (55.3) 125 (62.8) 44 (45.4) 88 (44.7) 74 (37.2) 55.2 (10.82) 55.5 (9.37) 55.4 (10.16) 24, 80 36, 78 25, 80 33.23 (6.192) 32.34 (5.698) 33.06 (5.379)|


-----

|Mean (SD) 8.03 (0.910) 7.91 (0.810) 7.91 (0.788) Duration of T2DM (years) Mean (SD) 4.32 (5.286) 3.09 (3.825) 2.82 (3.016) Median 2.67 1.92 1.67|7.97 (0.818) 8.08 (0.910) 8.01 (0.837) 7.76 (6.667) 7.68 (5.585) 7.38 (5.350) 6.50 6.33 6.17|
|---|---|

##### **Table 10 Sub j ect Demo g ra p hics and baseline Characteristics (322OPI-004) **
...
|Characteristic|Study 322OPI-004 Add-on to PIO/MET|
|---|---|
||MET+A25+P30 MET+P45 Total N=404 N=399 N=803|
|Sex, n (%) Men Women Age Mean (SD), yr <65 years, n (%) ≥65 years, n (%) ≥75 years, n (%) BMI|210 (52.0) 204 (51.1) 414 (51.6) 194 (48.0) 195 (48.9) 389 (48.4) 54.3 (9.86) 55.9 (9.94) 55.1 (9.93) 339 (83.9) 320 (80.2) 659 (82.1) 65 (16.1) 79 (19.8) 144 (17.9) 5 (1.2) 7 (1.8) 12 (1.5)|


|HbA1c Mean (SD) T2DM duration, yr Mean (SD) MET dose (mg) Mean (SD) Median (range)|n=303 (a) n=306 (a) - 8.25 (0.820) 8.13 (0.832) - 7.47 (5.248) 6.85 (4.611) 7.16 (4.946) 1867.9 (476.71) 1847.6 (494.12) 1857.8 (485.24) 1700 (500-3400) 1700 (500-3000) 1700 (500-3400)|
|---|---|
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 76/136


-----

##### **Figure 1 Study 009 (add-on to TZD): Change from baseline in LS Mean of HbA1c **
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 77/136


-----

##### **Figure 2 LS Mean (SE) Changes From baseline in HbA1c (%) (LOCF, PPS), study **
...
levels compared with the placebo group at every time point. **Table 11 Chan g e From baseline in HbA1c ( % ) ( LOCF, FAS ) ( stud y 010 )**
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 78/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 79/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 80/136

|Table 12. Summary of Efficacy for Study 010|Col2|Col3|Col4|Col5|Col6|Col7|Col8|Col9|
|---|---|---|---|---|---|---|---|---|
...
||Duration of Main phase: Duration of Run-in phase: Duration of Extension phase:||||26 weeks 4 weeks (single-blind placebo) 4 years via Study SYR-322-OLE-012 (eligible subjects only)||||
...
|Descriptive statistics and estimate variability||Treatment group||Placebo|||A12.5|A25|
|||Number of subjects||63|||131|128|
|||LS mean change||-0.02|||-0.56|-0.59|
|||SE||0.094|||0.065|0.066|
|Effect estimate per comparison||Primary endpoint: HbA1c (%)||Comparison group|||A12.5 vs Placebo|A25 vs Placebo|
|||||LS mean difference|||-0.54|-0.57|
|||||95% CI|||-0.76, -0.31|-0.80, -0.35|


-----

|Title: A Multicenter, Randomized, Double-Blind, Placebo-Controlled Study to Determine the Efficacy and Safety of SYR110322 (SYR-322) Compared with Placebo in Subjects with Type 2 Diabetes|Col2|Col3|Col4|Col5|Col6|
|---|---|---|---|---|---|
|Study identifier|SYR-322-PLC-010 (also referred to as Study 010)|||||
||||p-value|<0.001|<0.001|
|Notes||None.||||

|Summary of Efficacy for Study 010 (continued)|Col2|Col3|Col4|Col5|Col6|
|---|---|---|---|---|---|
|Title: A Multicenter, Randomized, Double-Blind, Placebo-Controlled Study to Determine the Efficacy and Safety of SYR110322 (SYR-322) Compared with Placebo in Subjects with Type 2 Diabetes||||||
|Study identifier|SYR-322-PLC-010 (also referred to as Study 010)|||||
|Analysis description||Key Secondary Endpoint Analysis: Same as primary model except with baseline FPG value in place of HbA1c as covariate.||||
|Analysis population and time point description||FAS||||
|Descriptive statistics and estimate variability||Treatment group|Placebo|A12.5|A25|
|||Number of subjects|64|132|129|
|||LS mean change|0.628|-0.571|-0.913|
|||SE|0.2910|0.2010|0.2038|
|Effect estimate per comparison||Secondary endpoint: FPG (mmol/L)|Comparison group|A12.5 vs Placebo|A25 vs Placebo|
||||LS mean difference|-1.199|-1.541|
||||95% CI|-1.896, -0.503|-2.243, -0.839|
||||p-value|<0.001|<0.001|
|Notes||None.||||
|Analysis description||Other Endpoint Analysis: Same as primary model except with baseline body weight value in place of HbA1c as covariate.||||
|Analysis population and time point description||FAS||||
|Descriptive statistics and estimate variability||Treatment group|Placebo|A12.5|A25|
|||Number of subjects|63|126|125|
|||LS mean change|0.18|-0.09|-0.22|
|||SE|0.368|0.258|0.259|
|Effect estimate per comparison||Other endpoint: body weight (kg)|Comparison group|A12.5 vs Placebo|A25 vs Placebo|
||||LS mean difference|-0.28|-0.40|
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 81/136


-----

|Table 13. Summary of Efficacy for Study 009|Col2|Col3|Col4|Col5|Col6|Col7|Col8|Col9|
|---|---|---|---|---|---|---|---|---|
|Title: A Multicenter, Randomized, Double-Blind, Placebo-Controlled Study to Determine the Efficacy and Safety of SYR110322 (SYR-322) When Used in Combination with Pioglitazone in Subjects with Type 2 Diabetes|||||||||
|Study identifier|SYR-322-TZD-009 (also referred to as Study 009)||||||||
|Design|Phase III, randomized, double-blind, placebo-controlled, parallel-group||||||||
||Duration of Main phase: Duration of Run-in phase: Duration of Extension phase:||||26 weeks 4 weeks (single-blind placebo and open-label pioglitazone 30 mg or MTD [converted from comparable rosiglitazone dose, as applicable]) 4 years via Study SYR-322-OLE-012 (eligible subjects only)||||
...
|Descriptive statistics and estimate variability||Treatment group||Placebo|||A12.5|A25|
|||Number of subjects||95|||196|195|
|||LS mean change||-0.19|||-0.66|-0.80|
|||SE||0.081|||0.056|0.056|
|Effect estimate per comparison||Primary endpoint: HbA1c (%)||Comparison group|||A12.5 vs Placebo|A25 vs Placebo|
|||||LS mean difference|||-0.47|-0.61|
|||||95% CI|||-0.67, -0.28|-0.80, -0.41|
|||||p-value|||<0.001|<0.001|


CHMP assessment report
EMA/CHMP/208477/2013 Page 82/136


-----

|Title: A Multicenter, Randomized, Double-Blind, Placebo-Controlled Study to Determine the Efficacy and Safety of SYR110322 (SYR-322) When Used in Combination with Pioglitazone in Subjects with Type 2 Diabetes|Col2|Col3|
|---|---|---|
|Study identifier|SYR-322-TZD-009 (also referred to as Study 009)||
|Notes||None.|

|Summary of Efficacy for Study 009 (continued)|Col2|Col3|Col4|Col5|Col6|
|---|---|---|---|---|---|
|Title: A Multicenter, Randomized, Double-Blind, Placebo-Controlled Study to Determine the Efficacy and Safety of SYR110322 (SYR-322) When Used in Combination with Pioglitazone in Subjects with Type 2 Diabetes||||||
|Study identifier|SYR-322-TZD-009 (also referred to as Study 009)|||||
|Analysis description||Key Secondary Endpoint Analysis: Same as primary model except with baseline FPG value in place of HbA1c as covariate.||||
|Analysis population and time point description||FAS||||
|Descriptive statistics and estimate variability||Treatment group|Placebo|A12.5|A25|
|||Number of subjects|97|196|197|
|||LS mean change|-0.318|-1.092|-1.103|
|||SE|0.2117|0.1490|0.1484|
|Effect estimate per comparison||Secondary endpoint: FPG (mmol/L)|Comparison group|A12.5 vs Placebo|A25 vs Placebo|
||||LS mean difference|-0.775|-0.785|
...
|Analysis population and time point description||FAS||||
|Descriptive statistics and estimate variability||Treatment group|Placebo|A12.5|A25|
|||Number of subjects|94|193|189|
|||LS mean change|1.04|1.46|1.09|
|||SE|0.329|0.230|0.232|
|Effect estimate per comparison||Other endpoint: body weight (kg)|Comparison group|A12.5 vs Placebo|A25 vs Placebo|
||||LS mean difference|0.42|0.05|
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 83/136


-----

|Table 14. Summary of Efficacy for Study 322OPI-004|Col2|Col3|Col4|Col5|Col6|Col7|Col8|Col9|
|---|---|---|---|---|---|---|---|---|
|Title: A Multicenter, Randomized, Double-Blind Study to Determine the Efficacy and Safety of the Addition of SYR-322 25 mg versus Dose Titration from 30 mg to 45 mg of ACTOS® Pioglitazone HCl in Subjects with Type 2 Diabetes Mellitus Who Have Inadequate Control on a Combination of Metformin and 30 mg of Pioglitazone HCl Therapy|||||||||
|Study identifier|01-06-TL-322OPI-004 (also referred to as Study 322OPI-004)||||||||
|Design|Phase III, randomized, double-blind, parallel-group||||||||
||Duration of Main phase: Duration of Run-in phase: Duration of Extension phase:||||52 weeks 4 weeks (open-label pioglitazone 30 mg with metformin 1500 mg or MTD) Not applicable||||
|Hypothesis|Noninferiority analysis of alogliptin combination treatment with pioglitazone (plus background metformin) compared with pioglitazone titration (plus background metformin) as measured by HbA1c change from baseline to Weeks 26 and 52||||||||
|Treatment groups|Alogliptin 25 mg (A25)||||52-week treatment with A25 QD as add-on to pioglitazone 30 mg (P30) and metformin 1500 mg or MTD, 404 subjects randomized||||
||Pioglitazone 45 mg (P45)||||52-week treatment with P45 QD as add-on to metformin 1500 mg or MTD, 399 subjects randomized||||
|Endpoints and definitions|Primary endpoint||Noninferiority|||HbA1c change from baseline to Weeks 26 and 52|||
||Key secondary endpoint||Exploratory|||FPG change from baseline to Weeks 26 and 52|||
||Other endpoint||Exploratory|||Body weight change from baseline to Weeks 26 and 52|||
|Database lock|09 July 2009||||||||
|Results and Analysis|||||||||
|Analysis description||Primary Endpoint Analysis: An ANCOVA model using LOCF values was performed, with study treatment, geographic region, and study schedule (see notes below) as class variables and baseline metformin dose and baseline HbA1c as continuous covariates. At Week 26, the A25+P30 dose was compared with P45 at the 1-sided 0.025 significance level using a noninferiority margin of 0.3%. If this test result was statistically significant, Week 52 was evaluated in a similar fashion.|||||||
|Analysis population and time point description||Per protocol set, which was defined as all FAS subjects (ie, those randomized who received at least 1 dose of double-blind study drug, had a baseline value, and had at least one post baseline value) who had no major protocol violations.|||||||
|Descriptive statistics and estimate variability||Week 52||Treatment group|||A25+P30|P45|
|||||Number of subjects|||303|306|
|||||LS mean change|||-0.70|-0.29|
|||||SE|||0.048|0.048|
|Effect estimate per comparison||Week 52||Primary endpoint: HbA1c (%)|||Comparison group|A25+P30 vs P45|
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 84/136


-----

|Summary of Efficacy for Study 322OPI-004 (continued)|Col2|Col3|Col4|Col5|Col6|
|---|---|---|---|---|---|
|Title: A Multicenter, Randomized, Double-Blind Study to Determine the Efficacy and Safety of the Addition of SYR-322 25 mg versus Dose Titration from 30 mg to 45 mg of ACTOS® Pioglitazone HCl in Subjects with Type 2 Diabetes Mellitus Who Have Inadequate Control on a Combination of Metformin and 30 mg of Pioglitazone HCl Therapy||||||
|Study identifier|01-06-TL-322OPI-004 (also referred to as Study 322OPI-004)|||||
|Notes||Subjects entered the Screening Period via 1 of 2 study schedules: - Schedule A for subjects with HbA1c of 7.0% to 10.0% while on a stable (2 months) regimen of pioglitazone 30 mg with metformin ≥1500 mg or MTD. These subjects directly entered the run-in phase. - Schedule B for subjects with HbA1c ≥7.5% while on metformin with other oral antidiabetic agent. These subjects entered a 12-week switching period, discontinued their antidiabetic treatment, were switched to pioglitazone 30 mg with metformin ≥1500 mg or MTD, and had to achieve HbA1c of 7.0% to 10.0% before entering the run-in phase.||||
|Analysis description||Key Secondary Endpoint Analysis: Same as primary model except with baseline FPG value in place of HbA1c as covariate and at the 0.05 2-sided significance level for statistical difference rather than for non-inferiority.||||
|Analysis population and time point description||FAS||||
|Descriptive statistics and estimate variability||Week 52|Treatment group|A25+P30|P45|
||||Number of subjects|399|396|
||||LS mean change|-0.813|-0.207|
||||SE|0.1048|0.1051|
|Effect estimate per comparison||Week 52|Secondary endpoint: FPG (mmol/L)|Comparison group|A25+P30 vs P45|
|||||LS mean difference|-0.606|
|||||95% CI|-0.897, -0.315|
|||||p-value|<0.001|
|Notes||None.||||
|Analysis description||Other Endpoint Analysis: Same as primary model except with baseline body weight value in place of HbA1c as covariate and at the 0.05 2-sided significance level for statistical difference rather than for non-inferiority.||||
|Analysis population and time point description||FAS||||
|Descriptive statistics and estimate variability||Week 52|Treatment group|A25+P30|P45|
||||Number of subjects|395|394|
||||LS mean change|1.10|1.60|
||||SE|0.194|0.194|
|Effect estimate per comparison||Week 52|Other endpoint: body weight (kg)|Comparison group|A25+P30 vs P45|
|||||LS mean difference|-0.50|
|||||95% CI|-1.03, 0.04|
|||||p-value|0.071|
|Notes||None.||||
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 86/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 87/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 88/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 89/136
...
or moderate renal impairment. ***2.6. Clinical safety ***
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 90/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 91/136
...
##### **Table 17 Ex p osure b y Dose and Duration – All Alo g li p tin Phase III Studies **

**Active**

**Exposure** **Placebo** **Comparator** **A12.5 mg** **A25 mg** **All Alogliptin (a)**

**Controlled Phase 2 and 3 Study Group**

**N=793** **N=2257** **N=2476** **N=3749** **N=6354**

Cumulative exposure 307.76 1528.22 1453.25 2249.74 3725.98
(subjects-years) (b)
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 93/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 94/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 95/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 96/136
...
##### **Table 20 Overview of TEAEs and SAEs - Controlled Phase 2 and 3 Study Grou p**
...
**Placebo** **Comparator** **A12.5** **A25** **Alogliptin (a)**

**Event Type** **N=793** **N=2257** **N=2476** **N=3749** **N=6354**

Any TEAE 514 (64.8) 1548 (68.6) 1672 (67.5) 2497 (66.6) 4234 (66.6)

[438.0] [330.1] [333.2] [342.1] [340.5]

Leading to 18 (2.3) 132 (5.8) 88 (3.6) 155 (4.1) 248 (3.9)
discontinuation of study [5.8] [8.7] [6.5] [7.1] [7.0]
drug

SAEs 25 (3.2) 117 (5.2) 100 (4.0) 175 (4.7) 277 (4.4)

[9.4] [9.9] [8.5] [9.9] [9.3]

Deaths 0 4 (0.2) 5 (0.2) 4 (0.1) 9 (0.1)

[0.3] [0.3] [0.2] [0.2]

CHMP assessment report
EMA/CHMP/208477/2013 Page 97/136
...
**Phase 2 and 3 Stud** **y** **Grou** **p**
**Number (%) of Subjects**

**Active** **All**

**OC** **Placebo** **Comparator** **A12.5** **A25** **Alogliptin (a)**

**Preferred Term** **N=793** **N=2257** **N=2476** **N=3749** **N=6354**
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 98/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 99/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 100/136
...
adjudicated as MACE (CV death, nonfatal MI, and nonfatal stroke) are presented in the table below. **Table 22 Summary of Adjudicated MACE – Main Phase III Studies (studies 009 and **
...
**Placebo** **Comparators** **A12.5** **A25** **All Alogliptin**

**Study** **n/N (%)** **n/N (%)** **n/N (%)** **n/N (%)** **n/N (%)** **Overall 0/97 3/399 (0.8) 2/197 (1.0) 4/603 (0.7) 6/800 (0.8) ** 009 0/97 N/A 2/197 (1.0) 2/199 (1.0) 4/396 (1.0) 322OPI-004 N/A 3/399 (0.8) N/A 2/404 (0.5) 2/404 (0.5)
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 101/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 102/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 103/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 104/136
...
*Pancreatic Cancer:* U ncertainties remained during the procedure regarding effects of alogliptin on
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 105/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 106/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 107/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 108/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 109/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 110/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 111/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 112/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 113/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 114/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 115/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 116/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 117/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 118/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 119/136
...
can not be used in these patients. ***2.7. Pharmacovigilance ***
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 120/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 121/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 122/136

|Summary of safety concerns|Col2|
|---|---|
|Important identified risks|Hypersensitivity reactions Hepatotoxicity Pancreatitis Cardiac failure Bladder cancer Peripheral edema and weight gain Bone fractures in women|
...
product.  Risk minimisation measures

Summary table of Risk Minimisation Measures

CHMP assessment report
EMA/CHMP/208477/2013 Page 123/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 124/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 125/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 126/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 127/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 128/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 129/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 130/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 131/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 132/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 133/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 134/136
...
heart failure associated with its use.  According to PROactive long term follow up and utilisation studies, a large proportion of
...
cancer risk is likely to reduce adherence to pioglitazone long-term treatment.  Several other serious risks have already been identified, as cardiac failure, weight increase,
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 135/136
...
CHMP assessment report
EMA/CHMP/208477/2013 Page 136/136
