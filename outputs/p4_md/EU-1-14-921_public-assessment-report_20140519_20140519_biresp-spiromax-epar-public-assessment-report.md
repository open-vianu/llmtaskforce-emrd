...
strength) or 120 doses (middle strength) and is foil-wrapped. **2.2.2. Active Substance **
...
stored below 25 [o] C is granted.
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 50/106
...
AUC 0-t, AUC 0-inf and C max were not contained within (0.8, 1.25)

  - For batches B and D of BF Spiromax the systemic availability of plasma budesonide

was comparable with Symbicort Turbohaler and the 90% CIs for the ratios of AUC 0-t,

CHMP assessment report
EMA/CHMP/175684/2014 Page 51/106


-----

and AUC 0-inf were contained within (0.8, 1.25); however, C max, for both batch B and
...
Symbicort Turbohaler with respect to BUD t½ and t max .
...
of AUC 0-t, and AUC 0-inf were contained within (0.8, 1.25); however, C max, for both
...
AUC 0-inf and C max were all contained within (0.8, 1.25);

  - For batch C the systemic availability of plasma formoterol fumarate was not

comparable with Symbicort Turbohaler and the 90% CIs for the ratios of AUC 0-t,

AUC 0-inf and C max were not contained within (0.8, 1.25).
...
Symbicort Turbohaler with respect to FOR t½ and t max.
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 52/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 53/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 54/106
...
||C (pg/mL) max|0.9726|0.9221|1.0260||0.249|0.234|Yes|
||t (h)a max|0.000|0.000|0.000|||||
|BF Spiromax (80/4.5 µg) + charcoal vs. Symbicort|AUC 0-t (h·pg/mL)|0.8757|0.8310|0.9227||0.189|0.226|Yes|
||C (pg/mL) max|0.9348|0.8839|0.9885||0.208|0.236|Yes|


CHMP assessment report
EMA/CHMP/175684/2014 Page 55/106
...
|Study / Comparison Turbohaler (100/6 µg) + charcoal|Parameter|Ratiob|90% Confidence Interval|Col5|RMS Error|Col7|Col8|BE (yes/no)|
|---|---|---|---|---|---|---|---|---|
||||Lower|Upper|Overall|BFS|ST||
||t (h)a max|0.000|0.00|0.00|||||
||||||||||
|Study BFS-AS-104 BF Spiromax (320/9 µg) vs. Symbicort Turbohaler (400/12 µg|AUC 0-t (h·pg/mL)|174.53|161.14|189.03|||0.585|No|
||C (pg/mL) max|187.17|174.06|201.27|||0.517|No|
||t (min)a max|-0.01|-0.18|0.15|||||
|BF Spiromax (320/9 µg) + charcoal vs. Symbicort Turbohaler (400/12 µg) + charcoal|AUC 0-t (h·pg/mL)|155.87|140.68|172.70|||0.585|No|
||C (pg/mL) max|167.35|153.60|182.33|||0.517|No|
||t (min)a max|0.05|-0.12|0.20|||||

EMA/CHMP/175684/2014 Page 56/106
...
#### C) Low Strength – B iRes p Spiromax 80/4.5 µg per dose, inhalation powder
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 57/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 58/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 59/106
...
||C (pg/mL) max|91.6|84.5|99.4|0.327|||Yes|
||t (min)a max|-0.38|-2.3|0.3|NA||||
|BF Spiromax (80/4.5 µg) + charcoal vs. Symbicort|AUC 0-t (h·pg/mL)|91.3|86.5|96.3|0.214|||Yes|
||C (pg/mL) max|97.7|90.0|106.1|0.327|||Yes|

EMA/CHMP/175684/2014 Page 60/106


-----

|Turbohaler (100/6 µg) + charcoal|t (min)a max|-2.6|-4.8|-1.1|NA|Col7|Col8|Col9|
|---|---|---|---|---|---|---|---|---|
...
|---|---|---|---|---|---|---|---|---|
||||Lower|Upper|Overall|BFS|ST||
|Study BFS-AS-103 BF Spiromax (80/4.5 µg) vs. Symbicort Turbohaler (100/6 µg)|AUC 0-t (h·pg/mL)|102.8|97.3|108.6|0.222|||Yes|
||C (pg/mL) max|119.3|112.6|126.3|0.23|||No|
||t (min)a max|-0.04|-0.24|0.13|NA||||
|BF Spiromax (80/4.5 µg) + charcoal vs. Symbicort Turbohaler (100/6 µg) + charcoal|AUC 0-t (h·pg/mL)|110.7|104.8|117.0|0.222|||Yes|
||C (pg/mL) max|137.6|129.9|145.7|0.23|||No|
||t (min)a max|-0.34|-1.25|-0.03|NA||||
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 61/106
...
|Strength/Study|With Charcoal|Col3|Without Charcoal|Col5|
|---|---|---|---|---|
||AUC 0-t|C max|AUC 0-t|C max|
|High Strength (BF Spiromax 320/9µg compared with Symbicort Turbohaler 400/12µg)|||||
...
|BUD|||Yes|Yes|
|FOR|||Yes|No|
|Middle Strength (BF Spiromax 160/4.5µg compared with Symbicort Turbohaler 200/6µg)|||||
...
|BUD|No|No|No|No|
|FOR|No|No|No|No|
|Low Strength (BF Spiromax 80/4.5µg compared with Symbicort Turbohaler 100/6µg)|||||
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 62/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 63/106
...
*patient population. The minimum (e.g. 10* *[th]* *percentile), median and maximum (e.g. 90* *[th]*
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 64/106


-----

**Peak Inspiratory Flow Rates (PIFR, L/min) Generated by Different Patient Groups**
**Post-training Through (placebo) Spiromax and Turbohaler devices (10** **[th]** **, 50** **[th]** **and**
...
- In asthma, the 10 [th] percentile was equal to or greater than 50L/min in children,

adolescents and adults using both inhalation devices.

- In COPD, the 10 [th] percentile was approx. 40L/min through both devices.

- The PIFR 90 [th] percentile was between 84-105L/min for all patient groups (asthma and

COPD).

- The PIFR 50 [th] percentile was between 60-88L/min for all patient groups (asthma and
...
|Post-training Through (placebo) 90th Percentiles)|Spiromax and Turbohaler|r devices (10, 50 and|
|---|---|---|
|Study Group|Turbohaler|Spiromax|
...
|API|Parameter|BF Spiromax|Col4|Col5|Symbicort|Col7|Col8|
|---|---|---|---|---|---|---|---|
...
EMA/CHMP/175684/2014 Page 65/106
...
|Col1|Symbicort FPD Symbicort Total Dose|
|---|---|
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 66/106
...
|Col1|BF Spiromax FPD BF Spiromax Total Dose|
|---|---|
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 68/106
...
- Primary pharmacodynamic e n dp oi nt: Change from baseline in corrected QT interval using
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 69/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 70/106
...
H 0 : |µSpiromax - µSymbicort| >10msec, for at least one of the cumulative doses at either

the low or high strength

versus

H 1 : |Spiromax - _Symbicort| ≤10msec, for all cumulative doses at both the low and high

strengths

CHMP assessment report
EMA/CHMP/175684/2014 Page 71/106
...
dose and standardized area under the curve between 0 and 4 hours (AUC 0-4 ) for QTcB, QTcF

CHMP assessment report
EMA/CHMP/175684/2014 Page 72/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 73/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 74/106
...
dose and standardised AUC 0-4 for QTcB, QTcF and uncorrected QT intervals for BF Spiromax
...
in heart rate, as well as in maximum change from baseline and standardized AUC 0-4, were
...
standardised AUC 0-4, did not exceed approximately 0.3-0.4 mmol/L.
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 75/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 76/106


-----

achieving pharmacokinetic bioequivalence for formoterol fumarate C max suggested that a
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 77/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 78/106
...
some slight lowering of C max, in the absence of charcoal blockade, for both formoterol
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 79/106
...
extensively, is well known and has been the subject of many publications. **2.5.1. Discussion on clinical efficacy **
...
Applicant seek approval of the lower strength fixed-dose combination in the future. ***2.6. Clinical safety ***
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 82/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 83/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 84/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 85/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 86/106
...
|Lower Leg Growth BFS-AS-305 Mean (SD) Lower|Rate by Knemometry in Each Period (PP Population) in Study Treatment period|Col3|Col4|Col5|
|---|---|---|---|---|
|Mean (SD) Lower leg growth rate (mm/week)|Treatment period||||
||1|2|3|All combined|
...
|Analysis of Lower Leg G AS-305|Growth Rate b|by Knemometry (PP Population) in Study BFS-|Col4|
|---|---|---|---|
|Lower leg growth rate (mm/week)|LS mean|Treatment difference (95% CI)||
|||BF Spiromax - Symbicort Turbohaler|Active - placebo|
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 88/106

|Analysis of Cortisol and Study BFS-AS-305|Cortisol/Creatini|ine Ratio (Modified UC Population)1 in|Col4|
|---|---|---|---|
|Variable Treatment|LS means|Geometric mean ratio (95% CI)||
|||BF Spiromax/Symbicort Turbohaler|Active/placebo|
|Cortisol||||
...
|Variable Treatment|LS mean change from period-specific baseline|Treatment difference (95% CI)|Col4|
|---|---|---|---|
|||BF Spiromax – Symbicort Turbohaler|Active vs Placebo|
|AM PEF||||
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 89/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 90/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 91/106
...
This was agreed by the Applicant and the indication in adolescents was withdrawn. ***2.7. Pharmacovigilance ***

**Detailed description of the pharmacovigilance system**

The CHMP considered that the Pharmacovigilance system as described by the applicant

fulfils the legislative requirements. ***2.8. Risk Management Plan ***
...
|IMPORTANT IDENTIFIED RISKS|• Systemic glucocorticosteroid effects • Cardiac effects of long-acting adrenergic beta receptor agonists 2 (LABA)|
|---|---|

EMA/CHMP/175684/2014 Page 92/106


-----

|Col1|• Life-threatening and fatal asthma events with long-acting adrenergic beta receptor agonists 2 • Paradoxical bronchospasm • Hypokalaemia|
|---|---|
...
pharmacovigilance is sufficient to identify and characterise the risks of the product. • Risk minimisation measures
...
EMA/CHMP/175684/2014 Page 93/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 94/106
...
|Cardiac effects of long- acting adrenergic beta 2 receptor agonists (LABA)|Section 4.4, special warnings and precautions for use, SmPC: A fixed-dose combination of budesonide and formoterol fumarate dihydrate should be administered with caution in patients with thyrotoxicosis, phaeochromocytoma, diabetes mellitus, untreated hypokalaemia, hypertrophic obstructive cardiomyopathy, idiopathic subvalvular aortic stenosis, severe hypertension, aneurysm or other severe cardiovascular disorders, such as ischaemic heart disease, tachyarrhythmias or severe heart failure. Caution should be observed when treating patients with prolongation of the QTc-interval. Formoterol itself may induce prolongation of the QTc-interval. Potentially serious hypokalaemia may result from high doses of beta -adrenoceptor agonists. 2|None|


CHMP assessment report
EMA/CHMP/175684/2014 Page 95/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 96/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 97/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 98/106
...
|Safety concern|Routine risk minimisation measures|Additional risk minimisation measures|
|---|---|---|
|powder, 320/9.0 µg delivered dose corresponding to 400/12 µg metered dose, per actuation, in the “maintenance and reliever therapy regimen”|micrograms/9.0 micrograms should be used as maintenance therapy only. The lower strengths of Budesonide/Formoterol Spiromax are available for the maintenance and reliever therapy regimen. Recommended doses: 1 inhalation twice daily. Some patients may require up to a maximum of 2 inhalations twice daily Prescription-only medicine||
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 99/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 100/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 101/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 102/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 103/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 104/106
...
***medicinal product*** • Risk Management Plan (RMP)
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 105/106
...
CHMP assessment report
EMA/CHMP/175684/2014 Page 106/106
