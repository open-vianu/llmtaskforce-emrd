...
T max Time of maximum observed plasma concentration; if it occurs at more than one
...
with deoxycytidine 5´-triphosphate and becomes incorporated into HIV-1 DNA, resulting in viral
...
rotation, water content, limit of efavirenz enantiomer, related substances, and assay. The
...
related substances, tenofovir disoproxil dimer impurity, chloromethyl isopropyl carbonate and
...
manufacturing process. For this reason, the aim was that the tablet formulation should possess the
...
controlled by suitable limits to ensure consistent product performance.
...
Testing of New Drug Substances and Products. No significant changes were observed.
...
has been presented in a satisfactory manner for this generic medicinal product. The results of tests
...
environment. With this regard and on the basis of CHMP Guideline on the Environmental Risk
...
This is a generic application for only one strength; hence a biowaiver is not applicable. ***Clinical studies ***
...
AUC0-72. Tmax was calculated and provided for information purposes only.
...
were no clinically significant abnormalities in the vital signs of the subjects in this study. All
...
Safety in patients with renal impairment ***Pharmacovigilance plan ***

Routine pharmacovigilance activities are sufficient to identify and evaluate new information about
actual or potential risks.
Follow-up questionnaires for spontaneous adverse event reports have been implemented correctly
(Renal toxicity, Renal tubulopathy, Bone events due to proximal renal toxicity/loss of bone mineral
density, Lack of Efficacy, Increased efavirenz blood levels and CYP2B6 genetic polymorphisms,
High-grade hepatic enzyme elevation and severe hepatic events, Pregnancy and pregnancy
outcome forms, Nephrolithiasis).
...
|accidental concurrent use of ATR with any of its active components)|Section 4.4 in SmPC: • Warning that Efavirenz/Emtricitabine/Tenofovir disoproxil should not be coadministered with other medicinal products containing any of the same active components.|proposed|Col4|
|---|---|---|---|
...
|Col1|should not be used during breast-feeding. Statement indicating that emtricitabine and tenofovir have been shown to be excreted in human milk but there is insufficient information on their effects in newborns/infants. Statement that efavirenz has been shown to be excreted in milk in rats at concentrations much higher than those in maternal plasma. Recommendation that in order to avoid transmission of HIV to the infant, HIV infected women, do not breast-feed.|Col3|
|---|---|---|
...
fulfils the requirements of Article 8(3) of Directive 2001/83/EC. ***Periodic Safety Update Reports submission requirements ***
...
consensus that the benefit-risk balance of Efavirenz/Emtricitabine/Tenofovir disoproxil Krka is
...
/tenofovir disoproxil Krka therapy
