...
###### 2.1. Problem statement ............................................................................................. 11 2.2. Quality aspects .................................................................................................. 13 2.2.1. Introduction .................................................................................................... 13 2.2.2. Active Substance ............................................................................................. 13 2.2.3. Finished medicinal product ................................................................................ 16 2.2.4. Biosimilarity .................................................................................................... 20 2.2.5. Conclusions on the chemical, pharmaceutical and biological aspects ...................... 23 2.2.6. Recommendations for future quality development................................................ 24 2.3. Non-clinical aspects ............................................................................................ 24 2.3.1. Pharmacology ................................................................................................. 24 2.3.2. Pharmacokinetics............................................................................................. 25 2.3.3. Toxicology ...................................................................................................... 25 2.3.4. Ecotoxicity/environmental risk assessment ......................................................... 26 2.3.5. Discussion on non-clinical aspects...................................................................... 26 2.3.6. Conclusion on the non-clinical aspects ................................................................ 28 2.4. Clinical aspects .................................................................................................. 28 2.4.1. Introduction .................................................................................................... 28 2.4.2. Pharmacokinetics............................................................................................. 32 2.4.3. Pharmacodynamics .......................................................................................... 37 2.4.4. Discussion on clinical pharmacology ................................................................... 38 2.4.5. Conclusions on clinical pharmacology ................................................................. 40 2.5. Clinical efficacy .................................................................................................. 40 2.5.1. Main study ...................................................................................................... 41 2.5.2. Discussion on clinical efficacy ............................................................................ 55 2.5.3. Conclusions on clinical efficacy .......................................................................... 58 2.6. Clinical safety .................................................................................................... 59 .............................................................................................................................. 60 2.6.1. Discussion on clinical safety .............................................................................. 68 2.6.2. Conclusions on clinical safety ............................................................................ 70 2.7. Risk Management Plan ........................................................................................ 70 2.8. Pharmacovigilance .............................................................................................. 80 2.9. Product information ............................................................................................ 81 2.9.1. User consultation ............................................................................................. 81
...
||a n Regulatory macrophage i c induction in allogeneic MLR by i flow cytometry|MSB11022 and Humira® showed similar stimulatory activity of regulatory macrophage induction in allogeneic MLR.|Yes|
...
cells overexpressing non-cleavable tmTNF, the ADCC E Max ranges using healthy donors were 84-92% vs
...
Crohn and UC indications. ***2.4. Clinical aspects *** **2.4.1. Introduction **
...
(EMR200588-002). An overview is provided in the tabular overview of clinical studies below. ***GCP ***

The Clinical trials were performed in accordance with GCP as claimed by the applicant.

CHMP assessment report
EMA/214726/2019 Page 28/89
...
|---|---|---|---|---|---|---|---|---|
|EMR200588 -001|2 centres in 1 country|Phase I, randomized double-blind single-dose study with 3 parallel treatment groups: MSB11022, EU-approved Humira, US-licensed Humira.|MSB11022 EU-approved Humira, US-licensed Humira 40 mg sc single dose|To compare the PK, safety, immunogenicity and tolerability of MSB11022 with US-licensed Humira and EU-approved Humira.|Randomized: MSB11022: 79 EU-Humira: 79 US-Humira: 79 Completed: t MSB11022: 78 u EU-Humira: 78 a US-Humira: 77 r e g n o|70 days d e s i r o h|Male and female healthy volunteers|PK: AUC0-∞, Cmax, and AUC0-last Safety, tolerability, and immunogenicity data|
|EMR200588 -002 (AURIEL-Ps O)|69 centers in 12 countries|Phase III, randomized, double-blind, multiple-dose active comparator study with 2 parallel treatment groups: MSB11022 versus EU-approved Humira Extension with re-randomisatio n: EU-Humira to MSB11022 versus EU-Humira to EU-Humira|MSB11022 EU-approved Humira 40 mg sc biweekly i d e M|Primary: equivalence in efficacy of MSB11022 t c compared u with EU-approved d Humira o r p Secondary: similarity in a l pharmacokinetics, n efficacy, safety and i c immunogenicity of MSB11022 compared with EU-approved Humira.|l o Randomized: n MSB11022: 222 EU-Humira: 221 Treated in Core Treatment Period: MSB11022: 221 EU-Humira: 220 Re-randomized: MSB11022 to MSB11022: 214 EU-Humira to EU-Humira: 101 EU-Humira to MSB11022: 101 Treated in Extended Treatment Period: MSB11022 to MSB11022: 213 EU-Humira to EU-Humira: 101|Core Treatment Period: 15+1 weeks Extended Treatment Period: 37 weeks + 4 months safety evaluation|Patients with moderate to severe chronic plaque psoriasis|Primary: PASI75 at week 16 Main secondary: Percentage change in PASI at week 16 PK, safety, and immunogenicity data|


-----

|Col1|Col2|versus MSB11022 to MSB11022|Col4|Col5|EU-Humira to MSB11022: 101 Completed 24 weeks: MSB11022 to MSB11022: 210 EU-Humira to EU-Humira: 96 EU-Humira to MSB11022: 99|i s e d|Col8|Col9|
|---|---|---|---|---|---|---|---|---|
...
CHMP assessment report
EMA/214726/2019 Page 51/89


-----

CHMP assessment report
EMA/214726/2019 Page 52/89
...
|Table 10 Summary of efficacy for trial EMR200588-002|Col2|Col3|Col4|
|---|---|---|---|
...
|Design|d e Study EMR200588-002 was designed to test the clinical equivalence of MSB1102 in s comparison to EU-sourced Humira, in terms of efficacy, safety, and immunogenicity, in i r patients with moderate to severe plaque psoriasis. It was a 52-week randomized, o double-blind, Phase III study, consisting of a 15-week Core Treatment Period followed h by a 37-week Extended Treatment Period. It was planned to include approximately 382 u t patients. a|||
||Duration of main phase: l o Duration of Run-in phase: n t c u Duration of Extension phase: d o r p||r e g 0 - 16 weeks n o NA 16 - 54 weeks (treatment extension) 54 – 66 weeks (safety follow-up)|
|Hypothesis|l a n Equivalence i|||
|Treatment groups M|c i d Core Treatment Period|||
||e MSB11022||N=222 randomized to MSB11022 sc injection of 80 mg at week 1 and 40 mg at week 2 and every other week thereafter, for 14 weeks.|
||EU-Humira||N=221 randomized to EU-Humira sc injection of 80 mg at week 1 and 40 mg at week 2 and every other week thereafter, for 14 weeks.|
||Extension Treatment Period|||
||MSB11022 to MSB11022||N=214 re-randomized to continue MSB11022 40 mg sc every other week.|
||EU-Humira to MSB11022||N=101 re-randomized to switch to MSB11022 40 mg sc every other week.|
||EU-Humira to EU-Humira||N=101 re-randomized to continue EU-Humira 40 mg sc every other week.|
|Endpoints and|Primary endpoint|PASI75 response|At least 75% change in PASI (yes/no) at week 16 compared to baseline.|

EMA/214726/2019 Page 53/89
...
CHMP assessment report
EMA/214726/2019 Page 59/89


-----

In the Core Treatment Period, the most common AEs ( ≥ 2%) by organ class for MSB11022 and EU-Humira
...
CHMP assessment report
EMA/214726/2019 Page 60/89


-----

Hypersensitivity reactions occurred in 5 patients in the MSB11022 group (n=222) compared with 6
...
CHMP assessment report
EMA/214726/2019 Page 61/89


-----

The occurrence of AEs according to Preferred Term (Table 16) appeared to be dissimilar (in %) between
...
CHMP assessment report
EMA/214726/2019 Page 68/89


-----

occurred in eight patients in the MSB11022 group and in six patients in the EU-Humira group. More
...
CHMP assessment report
EMA/214726/2019 Page 69/89


-----

‘switchers’ and the patients continuing EU-Humira. Consequently, switching from EU-Humira to
...
|d Safety Concern 6 e|||
|Leukemia|Text in SmPC (refer to SmPC section 4.4): Section 4.4: Warning regarding the risk of leukemia and malignancies in the adult and pediatric population a In order to inform patients of these r e risks, corresponding text is also g present in the package leaflet. n o l To educate prescribers and patients o about the risk of malignancies n associated with the use of: t c • Patient Reminder Card u • HCP Educational Material|s Routine pharmacovigilance i r surveillance will be performed o including cumulative analysis of h t adverse event reports in PSURs. u Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient.|
|d o Safety Concern 7|||
|NMSC n i c i d e M|r p Text in SmPC (refer to SmPC section 4.4, 4.8): a l Section 4.4: Warning regarding the risk of NMSC and malignancies in the adult and pediatric population. Section 4.8: Incidence rates for NMSC from clinical trials are included. In order to inform patients of these risks, corresponding text is also present in the package leaflet. To educate prescribers and patients about the risk of malignancies associated with the use of: • Patient Reminder Card • HCP Educational Material|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient.|
|Safety Concern 8|||
...
|Safety Concern 9|||
|Merkel Cell Carcinoma (Neuroendocrine carcinoma of the skin)|Text in SmPC (refer to SmPC section 4.4, 4.8): Section 4.4: Warning regarding Merkel cell carcinoma (neuroendocrine carcinoma of the skin). Section 4.8: MCC is also listed as an adverse reaction identified in post marketing surveillance. In order to inform patients of these risks, corresponding text is also present in the package leaflet a To educate prescribers and patients r about the risk of malignancies e associated with the use of: g n • Patient Reminder Card o • HCP Educational Material l|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs Brand name and batch number will be recorded for traceability, whenever the information is d provided by the patient e s i Additional pharmacovigilance r o activity: This safety concern will be h monitored in the proposed category t u 3 studies, as feasible.|
|o Safety Concern 10|||
|Demyelinating disorders (including MS, GBS, and optic neuritis) n i c i d e M|n Text in SmPC (refer to SmPC t c section 4.4, 4.8): u Section 4.4: Warnings on d demyelinating disorders are o r included. p Further details for the uveitis patient l a population are also included. Section 4.8: Demyelinating disorders are also listed as adverse reaction identified in post marketing surveillance. In order to inform patients of these risks, corresponding Text is also present in the package leaflet. To educate prescribers and patients about 1) the risk of demyelinating disorders associated with the use of, and 2) the underlying risk of demyelinating disorders associated with uveitis, particularly intermediate uveitis: • Patient Reminder Card • HCP Educational Material|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient.|
|Safety Concern 11|||
...
|Safety Concern 12|||
|Sarcoidosis|Text in SmPC (refer to SmPC section 4.8): Section 4.8: Sarcoidosis is listed as an uncommon adverse reaction identified in post marketing surveillance. In order to inform patients of these risks, corresponding text is also present in the package leaflet.|Routine pharmacovigilance surveillance will be performed. Including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will d be recorded for traceability, e whenever the information is s provided by the patient. i r|
|o h Safety Concern 13|||
|Congestive Heart Failure n i c i d e M|Text in SmPC (refer to SmPC a section 4.3, 4.4 and 4.8): r Section 4.3: Moderate to severe e g CHF as contraindication to n Kromeya® use is contained in the o Contraindication section. l Section 4.4: Warning regarding o including worsening and new onset n CHF is included. It advises that t c MSB11022 should be used with u caution patients with mild heart d failure with instructions to stop o adalimumab in patients who develop r p new or worsening of symptoms of CHF. a l Section 4.8: CHF is also listed as an adverse reaction identified in clinical studies. In order to inform patients of these risks, corresponding text is also present in the package leaflet. To educate prescribers and patients about the risk of CHF associated with the use of: • Patient Reminder Card • HCP Educational Material|t u Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient.|
|Safety Concern 14|||
...
|Safety Concern 16|||
|Interstitial Lung Disease|Text in SmPC (refer to SmPC section 4.8): Section 4.8: Interstitial lung disease is listed as an adverse reaction identified in clinical studies. In order to inform patients of these risks, corresponding text is also present in the package leaflet.|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. d Brand name and batch number will e be recorded for traceability, s i whenever the information is r o provided by the patient. h|
|t u Safety Concern 17|||
|Pulmonary embolism|a Text in SmPC (refer to SmPC r e section 4.8): g Section 4.8: Pulmonary embolism is n listed as an adverse reaction o l identified in post marketing o surveillance. n In order to inform patients of these t risks, corresponding text is also c u present in the package leaflet.|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient.|
|d Safety Concern 18|||
|Cutaneous vasculitis n i c i d e M|o r Text in SmPC Text in SmPC (refer to p SmPC section 4.8): l a Section 4.8: Cutaneous vasculitis is listed as an adverse reaction identified in post marketing surveillance. In order to inform patients of these risks, corresponding text is also present in the package leaflet.|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient.|
|Safety Concern 19|||
...
|Safety Concern 21|||
|Worsening and New Onset of Psoriasis|Text in SmPC (refer to SmPC section 4.4): Section 4.4: Worsening and New Onset of Psoriasis is listed as an adverse reaction identified in post marketing surveillance Text in PIL: Worsening and new onset of Ps is addressed in section 4.8: Table 2: Worsening and New Onset of Psoriasis (including palmoplantar pustular psoriasis) is listed as an adverse drug reaction with a frequency of 'common' (includes spontaneous data). No text in relation to these risks is present in the package leaflet|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient. d e s|
|i r Safety Concern 22|||
|Hematologic disorders|Text in SmPC (refer to SmPC section 4.4): a Section 4.4: Warning regarding r hematologic reactions including e medically significant cytopenias is g included. It advises that n discontinuation of MSB11022 o l therapy should be considered in o patients with confirmed significant n hematologic abnormalities. t In order to inform patients of these c u risks, corresponding text is also d present in the package leaflet.|o h Routine pharmacovigilance t u surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient.|
|o Safety Concern 23 r|||
|Intestinal perforation n i c i d e M|p Text in SmPC (refer to SmPC l a section 4.8): Section 4.8: Intestinal perforation is listed as an adverse reaction identified in post marketing surveillance. In order to inform patients of these risks, corresponding text is also present in the package leaflet.|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient.|
|Safety Concern 24|||
...
|d e Safety Concern 27|||
|Autoimmune hepatitis|Text in SmPC (refer to SmPC section 4.8) Section 4.8: AIH is listed as an adverse reaction identified in post a marketing surveillance. r In order to inform patients of these e risks, corresponding text is also g present in the package leaflet. n o l o n t c u|s i Routine pharmacovigilance r o surveillance will be performed. h Including cumulative analysis of t u adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient. Additional pharmacovigilance activity: This safety concern will be monitored in the proposed category 3 studies, as feasible.|
|d Safety Concern 28|||
|Medication errors and maladministration n i c i d e M|o r Text in the SmPC: None. p Instructions for preparing and giving l a an injection of adalimumab are outlined in the Package Leaflet.|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient.|

|Potential risks Safety concern|Risk minimization measures|Pharmacovigilance activities|
|---|---|---|
|Safety concern|Risk minimization measures|Pharmacovigilance activities|
|Safety Concern 1|||
...
|Safety Concern 3|||
|PML|Text in SmPC: None Other routine risk minimization measures: Prescription only medicine.|Routine pharmacovigilance surveillance will be performed including cumulative analysis of d adverse event reports in PSURs. e s Brand name and batch number will i be recorded for traceability, o r whenever the information is h provided by the patient.|
|t u Safety Concern 4|||
|Reversible posterior leukoencephalopathy syndrome|a Text in SmPC: None e r Other routine risk minimization g measures: Prescription only n medicine. o l o n t|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient|
|c u Safety Concern 5|||
|ALS n i c i d e|d o Text in SmPC: None r Other routine risk minimization p measures: Prescription only l a medicine.|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient.|
|M Safety Concern 6|||
...
|Safety Concern 9|||
|Off-label use|Text in SmPC: None Other routine risk minimization measures: Prescription only medicine. a|Routine pharmacovigilance d surveillance will be performed e including cumulative analysis of s i adverse event reports in PSURs. r o Brand name and batch number will h be recorded for traceability, t u whenever the information is provided by the patient.|

##### ***Missing information ***

CHMP assessment report

|Safety concern|o Risk minimization measures|Pharmacovigilance activities|
|---|---|---|
|n Safety Concern 1|||
|Patients with immune-compromised conditions either due to underlying conditions (i.e., diabetes, renal or liver failure, HIV infection, alcohol or illicit drug abuse) or due to medications (post cancer n chemotherapy, anti-rejection drugs i c for organ transplant) may have i increased known risks of infection or d e other unknown risks related to the M condition or to the concomitant medications.|t c Text in SmPC (refer to SmPC u d section 4.4): o Section 4.4: Warnings regarding r patients with immune-compromised p conditions are included. l a There is currently no information on patients with a history of clinically significant drug or alcohol abuse listed in the SmPC. In order to inform patients of these risks, corresponding text is also present in the package leaflet.|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient|
|Safety Concern 2|||
...
|Safety Concern 4|||
|Remission-withdrawal­retreatment nr-axSpA data and episodic treatment in Ps, CD, UC, and JIA|The SmPC currently contains no text regarding remission- withdrawal-retreatment in nr-axSpA or episodic treatment in Ps, CD, UC, and JIA. Other routine risk minimization measures: Prescription only medicine.|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient|
|d Safety Concern 5|||
|Long-Term Safety Information in the Treatment of Adults with HS|Text in SmPC (refer to SmPC section 4.2): Section 4.2: Statements that the long-term safety and efficacy of MSB11022 in this population will be a periodically re-evaluated. r In order to inform patients of these e g risks, corresponding text is also n present in the package leaflet.|e s Routine pharmacovigilance i surveillance will be performed o r including cumulative analysis of h adverse event reports in PSURs. t u Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient.|
|o Safety Concern 6 l|||
|Long term safety data in the treatment of adults with uveitis|o Text in SmPC (refer to SmPC n section 4.2): t c Section 4.2: Statements that the u long-term safety and efficacy of d MSB11022 in this population will be o periodically re-evaluated. r p In order to inform patients of these l risks, corresponding text is also a present in the package leaflet.|Routine pharmacovigilance surveillance will be performed including cumulative analysis of adverse event reports in PSURs. Brand name and batch number will be recorded for traceability, whenever the information is provided by the patient.|

##### ***Conclusion ***

The CHMP and PRAC considered that the risk management plan version 3.0 is acceptable provided that

the applicant submits an RMP aligned to the originator’s 3 months after Commission Decision. ***2.8. Pharmacovigilance *** ***Pharmacovigilance system ***
...
Mea n+ 3SD intervals calculated for the originator; age at the time of testing is appropriately taken into
...
mannose variants (MSB11022: 1.9-2.5%; Humira-EU: 5.3-12.0%).
   ...
   - The K D -ranges (as determined by SPR) for FcγRIIIa F158 binding overlap but are not ‘within
...
ADCC of MSB11022 is lower than for Humira: NK-PBMC ADCC assay using %EC 50 as read-out.
...
CHMP assessment report
EMA/214726/2019 Page 84/89


-----

need to perform a study in this species. Consequently, this study does not provide decisive information
...
correlated to the potentially slightly higher K D for FcγRIIIa receptor (F158 low affinity variant) and lower

activity in ADCC assays when more sensitive assay formats, like the NK-PBMC assay (%EC 50 ), are used.
...
CHMP assessment report
EMA/214726/2019 Page 85/89


-----

Another mode of action proposed for adalimumab efficacy in IBD is inhibition of proliferation of activated
...
MSB11022 and the two Humira reference products as the primary parameters AUC 0-∞ AUC 0-t and C max,
...
```
80.00-125.00%, the upper limit of 90%CI for AUC inf excludes 1; 80.14 99.10. This statistical difference
...
CHMP assessment report
EMA/214726/2019 Page 86/89


-----

similarity of the ‘parent’ continuous PASI scores. The continuous PASI scores were highly similar between
...
related to membrane-bound TNF-associated modes of action. ***3.6. Additional considerations ***

None. ***3.7. Conclusions on biosimilarity and benefit risk balance ***
