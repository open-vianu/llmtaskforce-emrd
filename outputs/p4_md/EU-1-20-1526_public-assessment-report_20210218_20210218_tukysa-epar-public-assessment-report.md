...
##### 2.1. Problem statement ............................................................................................. 9 2.1.1. Disease or condition......................................................................................... 9 2.1.2. Epidemiology .................................................................................................. 9 2.1.3. Biologic features ............................................................................................ 10 2.1.4. Clinical presentation, diagnosis and stage/prognosis ........................................... 10 2.1.5. Management ................................................................................................. 10 2.2. Quality aspects ................................................................................................ 11 2.2.1. Introduction ................................................................................................. 11 2.2.2. Active Substance ........................................................................................... 11 2.2.3. Finished Medicinal Product .............................................................................. 14 2.2.4. Discussion on chemical, pharmaceutical and biological aspects ............................. 19 2.2.5. Conclusions on the chemical, pharmaceutical and biological aspects ..................... 19 2.2.6. Recommendation(s) for future quality development ............................................ 19 2.3. Non-clinical aspects .......................................................................................... 19 2.3.1. Introduction ................................................................................................. 19 2.3.2. Pharmacology ............................................................................................... 20 2.3.3. Pharmacokinetics .......................................................................................... 25 2.3.4. Toxicology .................................................................................................... 28 2.3.5. Ecotoxicity/environmental risk assessment ........................................................ 33 2.3.6. Discussion on non-clinical aspects .................................................................... 34 2.3.7. Conclusion on the non-clinical aspects .............................................................. 37 2.4. Clinical aspects ................................................................................................ 38 2.4.1. Introduction ................................................................................................. 38 2.4.2. Pharmacokinetics .......................................................................................... 39 2.4.3. Pharmacodynamics ........................................................................................ 49 2.4.4. Discussion on clinical pharmacology ................................................................. 53 2.4.5. Conclusions on clinical pharmacology ............................................................... 56 2.4.6. Dose response study ...................................................................................... 56 2.4.7. Main study ................................................................................................... 56 2.4.8. Discussion on clinical efficacy .......................................................................... 98 2.4.9. Conclusions on the clinical efficacy .................................................................. 103 2.5. Clinical safety ................................................................................................. 103 2.5.1. Discussion on clinical safety ........................................................................... 134 2.5.2. Conclusions on the clinical safety .................................................................... 138 2.6. Risk Management Plan ..................................................................................... 138 2.6.1. Safety Specification ...................................................................................... 138 2.7. Pharmacovigilance........................................................................................... 141 2.8. New Active Substance ...................................................................................... 141 2.9. Product information ......................................................................................... 142
...
**Table 1:** **EC** **50** **values for the inhibition of HER2, HER3, AKT, ERK1/2, and MEK1**
...
No carcinogenic studies have been conducted (see discussion on non-clinical aspects). ***Reproduction Toxicity ***
...
(AUC 0-24h ), respectively. According to non-clinical data the predominant circulating metabolite ONT-993
...
Aldehyde oxidase was determined to comprise approximately 15% of total tucatinib metabolism. ***Elimination ***
...
greater decrease in CL/F seems to be related to other factors that could not be individually identified. ***Dose proportionality ***
...
Assessment report
EMA/78409/2021 Page 43/148


-----

Geometric mean exposure tended to increase with increasing dose suggesting linearity between
...
treatment with T-DM1 or capecitabine with or without trastuzumab, compared to healthy subjects. ***Special populations ***
...
Assessment report
EMA/78409/2021 Page 47/148


-----

A Pop-PK model of tucatinib was developed to account for the impact of CYP3A4 inducers on the
...
Assessment report
EMA/78409/2021 Page 51/148


-----

The incidence of Adverse Events of Special Interest (AESIs) on Cycle 3 Day 1 was low and a large
...
Assessment report
EMA/78409/2021 Page 52/148


-----

The safety analysis indicated that drug-induced liver injury, cerebral oedema not attributable to
...
Assessment report
EMA/78409/2021 Page 53/148


-----

The pop-PK model underpredicted the highest concentrations in studies ARRAY-380-103 and ONT-380
...
Assessment report
EMA/78409/2021 Page 54/148


-----

such as gemfibrozil should be avoided as this may result in increased risk of tucatinib toxicity is
...
Assessment report
EMA/78409/2021 Page 55/148


-----

concentrations across treatment cycles 2-6. A clear exposure-response relationship could not be
...
program. **2.4.6. Dose response study **

For more details, please see the clinical pharmacology section. **2.4.7. Main study **

**Figure 7:** ~~**Figure**~~ ~~**3**~~ ~~**S**~~ **chematic of study design for HER2CLIMB**

Assessment report
EMA/78409/2021 Page 56/148
...
Assessment report
EMA/78409/2021 Page 57/148


-----

`o` lapatinib within 12 months of starting study treatment (except in cases where lapatinib
...
Assessment report
EMA/78409/2021 Page 58/148


-----

`o` hypoxia requiring supplementary oxygen therapy except when oxygen therapy was
...
Assessment report
EMA/78409/2021 Page 59/148


-----

**Tucatinib drug product and placebo** are supplied by the study sponsor as yellow round-shaped 50
...
Assessment report
EMA/78409/2021 Page 60/148


-----

-To assess health-related quality of life (HRQoL) and health economics based on subject health status
...
Progression-free survival (PFS BM ) time in the subgroup of patients with a history of brain metastases or
...
Progression-free survival (PFS INV ) time defined as the time from the date of randomisation to the date
...
Assessment report
EMA/78409/2021 Page 61/148


-----

Duration of response (DOR) defined as the time from the first objective response (CR or PR) to
...
secondary endpoint of PFS BM .

At the time of the primary analysis for PFS, part of the personnel will be unblinded, while others

involved in the analysis of PFS BM will remain blinded. The applicant has clarified that because the trial
...
for PFS BM and two formal interim analyses for superiority are planned for OS if the primary analysis for
...
if both of the key secondary endpoints (OS and PFS BM ) are statistically significant, then the ORR by
...
The two treatment arms will be compared for PFS using a stratified, log-rank test controlling for the
...
Assessment report
EMA/78409/2021 Page 65/148


-----

- Stratification: In the case of stratification errors >5% between what is recorded in IRT and eCRF, the
...
Assessment report
EMA/78409/2021 Page 66/148


-----

Comparison of the two treatment arms will be performed using a 2-sided Cochran-Mantel-Haenszel
...
Details of the censoring scheme for the analysis of PFS INV are the same as the primary endpoint PFS.

The primary analysis of PFS INV will be performed based on ITT-PFS set. PFS INV will also be summarised
...
PFS INV will also be summarised based on ITT-PFS BM set as exploratory analyses.
...
Assessment report
EMA/78409/2021 Page 67/148


-----

as in SAP. As exploratory analyses, the same analyses for DOR will also be conducted using ITT-PFS
...
impact of clinical progression were performed for PFS INV . Supplementary analysis for DOR were also
...
ITT-OS population ITT-PFS population

Tuc+Cap+Tra Tuc+Cap+Tra Tuc+Cap+Tra
...
Subjects with history of brain metastases 198 (48.3) 148 (46.3) 11 (41)
...
Assessment report
EMA/78409/2021 Page 70/148


-----

Assessment report
EMA/78409/2021 Page 71/148
...
Assessment report
EMA/78409/2021 Page 73/148


-----

**Figure 10:** ~~**Figure**~~ ~~**4**~~ **PFS per BICR assessment (ITT-PFS population)**
...
Assessment report
EMA/78409/2021 Page 74/148


-----

The results of all sensitivity analyses were consistent and supported the primary analysis of PFS per

BICR (Table 28).

**Table 28:** **Summary of PFS sensitivity analysis per BICR (ITT-PFS population)**

Nominal stratified log-rank Stratified hazard ratio [b, c ] (95%
...
Sensitivit y anal y sis 4 <0.00001 0.550 ( 0.426, 0.710 )
...
Assessment report
EMA/78409/2021 Page 75/148


-----

Sensitivity Analysis 3 (New therapy before PD/death): analysis for PFS time by ignoring all new anti-cancer therapies in censoring
scheme.
...
Assessment report
EMA/78409/2021 Page 77/148


-----

~~**Figure**~~ **Figure 11:** ~~**6**~~ ~~**Overall**~~ **Survival by Treatment Arm (ITT population – all randomised subjects)**
...
Assessment report
EMA/78409/2021 Page 79/148


-----

~~**Figure**~~ **Figure 12:** ~~**8**~~ ~~**PFS**~~ ~~**per**~~ ~~**B**~~ **ICR in the ITT-PFS** **BrainMets** **population**
...
Assessment report
EMA/78409/2021 Page 80/148


-----

**Table 33: Summary of intracranial confirmed objective response per investigator in subjects**
...
Confirmed ORR 47.3 20.0
(95% CI)c, % (33.7, 61.2) (5.7, 43.7)
...
Subjects with Clinical Benefit (Confirmed CR or PR, or non- 245 77
CR/non-PD or SD ≥ 6 months [d] ), n

Clinical Benefit Rate (CBR), % 59.8 38.1
95% CI [e] for CBR (54.8, 64.5) (31.4, 45.2)
Stratified CMH p - value for CBR [f] < .00001
a. Confirmed best overall response assessed per RECIST 1.1.
b. Subjects with no post-baseline response assessments
c. Subjects with no evidence of disease at baseline.
...
Subjects with Clinical Benefit (Confirmed CR or PR, or non- 238 76
CR/non-PD or SD ≥ 6 months [c] ), n

Clinical Benefit Rate (CBR), % 58.0 37.6
95% CI [d] for CBR (53.1, 62.9) (30.9, 44.7)
Stratified CMH p - value for CBR [e] < .00001
a. Confirmed best overall response assessed per RECIST 1.1.
b. Subjects with no post-baseline response assessments
...
**Figure 14:** ~~**Fi**~~ **gure** ~~**5**~~ ~~**H**~~ **azard ratio and 95% CI for PFS per BICR by subgroups (ITT-PFS population)**
...
Assessment report
EMA/78409/2021 Page 87/148


-----

**Figure 15:** ~~**Fi**~~ **gure** ~~**7**~~ **Hazard ratio and 95% CI for OS by subgroups (ITT-OS population)**
...
Assessment report
EMA/78409/2021 Page 88/148


-----

**Figure 16:** ~~**Fi**~~ **gure** ~~**9**~~ **Hazard ratio and 95% CI for PFS per BICR by subgroups (ITT-PFS** **BrainMets** **)**
...
Assessment report
EMA/78409/2021 Page 89/148


-----

|Study identifier|ONT-380-206 (HER2CLIMB)|Col3|Col4|
|---|---|---|---|
...
||Secondar y endpoint|OS|Overall survival in all 612 subjects randomised (N = 410 in the tucatinib arm; N = 202 in the control arm).|
||Secondar y endpoint|PFS BrainMe ts|PFS in the 291 subjects with brain metastases at baseline (N = 198 in the tucatinib arm; N = 93 in the control arm), defined as subjects with a history of brain metastases, current brain metastases, or equivocal brain lesions at baseline, using RECIST 1.1 based on BICR.|
...
Assessment report
EMA/78409/2021 Page 90/148


-----

|Data cutoff for primary analysis|04 September 2019|Col3|Col4|
|---|---|---|---|
|Results and Analysis||||
|Analysi s descript -tion|Primary Analysis|||
|Analysis populatio n and time point descript- tion|The primary analysis of PFS per BICR was conducted using the data cut-off date of 04 September 2019, at which time 275 PFS events (disease progression or death) had occurred in the ITT-PFS population (N = 480). The pre-specified interim analyses for the key secondary endpoints OS and PFS per BICR were conducted as a result of the statistically significant PFS BrainMets analysis. Both key secondary endpoints were statistically significant; therefore, OS and PFS BrainMets analyses are considered final and no more formal statistical testing will be conducted. Additionally, the alpha-controlled secondary endpoint of confirmed ORR by BICR was formally tested between two treatment arms and was also found to be statistically significant in favour of the tucatinib arm.|||
...
||Median PFS (months)|7.8|5.6|
||95% CI|(7.5, 9.6)|(4.2, 7.1)|
|||||
||Number of subjects|N = 410|N = 202|
||Median OS (months)|21.9|17.4|
||95% CI|(18.3, 31.0)|(13.6, 19.9)|
|||||
||Number of subjects|N = 198|N = 93|
||Median PFS BrainMets (months)|7.6|5.4|
||95% CI (6.2, 9.5) (4.1, 5.7) Number of subjects N = 340 N = 171|||
||cORR (%)|40.6|22.8|
...
|||95% CI|(0.420, 0.705)|
|||P-value|<0.00001|
||Secondary endpoint: OS|Comparison groups|Tucatinib arm vs control arm|
|||Hazard Ratio|0.662|
|||95% CI|(0.501, 0.875)|
|||P-value|0.00480|
||Secondary endpoint: PFS BrainMets|Comparison groups|Tucatinib arm vs control arm|
|||Hazard Ratio|0.483|
|||95% CI|(0.339, 0.689)|
|||P-value|<0.00001|
...
Assessment report
EMA/78409/2021 Page 91/148


-----

|Col1|Secondary endpoint: cORR|Comparison groups|Tucatinib arm vs control arm|
|---|---|---|---|
...
Age <65 years years years Age ≥ 85 years Total

( N=632 ) ( N=133 ) ( N=14 ) ( N=0 ) ( N=779 )
...
respectively). ***Supportive studies ***
...
Assessment report
EMA/78409/2021 Page 92/148


-----

pharmacokinetic (PK) and anti-tumour activity (both systemically and in the brain). The study
...
Assessment report
EMA/78409/2021 Page 93/148


-----

**Table 41: Study ONT-380-005 baseline disease characteristics – tucatinib triplet**
**combination**
...
Assessment report
EMA/78409/2021 Page 94/148


-----

16 subjects with no baseline history of brain metastases, 14 subjects (87.5%) had measurable disease
...
Assessment report
EMA/78409/2021 Page 95/148


-----

**Table 43: Study ONT-380-005 progression-free survival per investigator assessment –**
...
Assessment report
EMA/78409/2021 Page 96/148


-----

`o` The ORR in subjects with a baseline history of brain metastases was 55.6% (95%CI:
...
Assessment report
EMA/78409/2021 Page 97/148


-----

ARRAY-380-101 is a completed first-in-human, open-label, phase 1 dose-escalation study of tucatinib
...
Assessment report
EMA/78409/2021 Page 98/148


-----

The pivotal study included patients from 169 study centres over a period of ~3 years and
...
Assessment report
EMA/78409/2021 Page 99/148


-----

The strategy used to keep the overall type I error at 5% is accepted. It is noted that the testing
...
Both PFS BM and OS were analysed in a similar fashion as PFS, using a randomisation version of the log
...
Since no censoring rules were specified for PFS BM, it is understood that the same rules implemented for
...
for PFS BM are not agreed either. The applicant performed the same sensitivity analysis as for PFS to

PFS BM, which had concordant results with the primary analysis. According to the protocol, patients will
...
Assessment report
EMA/78409/2021 Page 100/148


-----

implemented, has been provided that overall shows consistency with the final analysis. These results
...
Assessment report
EMA/78409/2021 Page 101/148


-----

represent a relatively smaller proportion of the overall “Sum of Diameters” compared to visceral lesions
...
Assessment report
EMA/78409/2021 Page 102/148


-----

(4.7%). Only 5.6% received an antibody-conjugate, most frequently experimental agents as they
...
Regulation (EU) No 357/2015 indent a; See Annex II). ***2.5. Clinical safety *** **Patient exposure **
...
Assessment report
EMA/78409/2021 Page 103/148


-----

arm had received at least 12 months of tucatinib treatment and the median exposure to tucatinib was
...
**Table 44:** ~~**Table**~~ ~~**1:**~~ **Overall number of subjects exposed to tucatinib**

Number of Subjects

in non-clinical in vitro and in vivo systems (see clinical pharmacology section). **Discontinuation due to AES **
...
Subjects with any 7 (3.6) 23 (5.7) 25 (5.8) 25 (5.4) 4 (12.9)
event

Diarrhoea 1 (0.5) 4 (1.0) 5 (1.2) 5 (1.1) 0
Alanine 1 (0.5) 4 (1.0) 4 (0.9) 4 (0.9) 0
aminotransferase

increased

Aspartate 1 (0.5) 3 (0.7) 3 (0.7) 3 (0.6) 0
aminotransferase

increased

Blood bilirubin 1 (0.5) 3 (0.7) 3 (0.7) 3 (0.6) 0
increased
...
Respiratory 0 2 (0.5) 2 (0.5) 2 (0.4) 0
failure
...
Assessment report
EMA/78409/2021 Page 132/148


-----

Slightly more patients discontinued tucatinib/placebo on the tucatinib arm (5.7% vs 3.6%). The most
...
Assessment report
EMA/78409/2021 Page 133/148


-----

More patients in the tucatinib arm resumed capecitabine at the same dose, while a similar fraction
...
Not applicable. **2.5.1. Discussion on clinical safety **
...
Assessment report
EMA/78409/2021 Page 134/148


-----

are most likely due the toxicity of capecitabine. Headache may also be a symptom associated with a
...
Assessment report
EMA/78409/2021 Page 135/148


-----

monitored every three weeks or as clinically indicated. Based on the severity of the adverse reaction,
...
cumulative anthracycline doses equivalent to >360 mg/m [2] doxorubicin has been included in the list of

safety concerns under missing information. The Standard AE Reporting Form was updated to inquire if

patients received prior cumulative anthracycline doses equivalent to > 360 mg/m [2] doxorubicin when

cardiac events are reported which will allow closer monitoring of cardiotoxicity in patients who have

received prior anthracycline doses equivalent to >360 mg/m [2] in the post-marketing setting. The two
...
Assessment report
EMA/78409/2021 Page 136/148


-----

There were more treatment-related adverse events in the tucatinib arm vs placebo arm of the
...
Assessment report
EMA/78409/2021 Page 137/148


-----

Based on findings from animal studies and its mechanism of action, tucatinib may cause harmful
...
and trastuzumab is considered overall acceptable and clinically manageable. ***2.6. Risk Management Plan ***

The Safety Specification (Part II, SI-SVIII) from RMP version 0.3, dated 04-NOV-2020 is assessed

below. **2.6.1.  Safety Specification **

***Summary of safety concerns***

|Table 73: Summary of safety concerns|Col2|
|---|---|
|Summary of safety concerns||
...
The CHMP and PRAC considered that the risk management plan version 0.3 is acceptable. ***2.7. Pharmacovigilance *** ***Pharmacovigilance system ***
...
therefore use the IBD to determine the forthcoming Data Lock Points. ***2.8. New Active Substance ***
...
treatment regimens. **3.1.2. Available therapies and unmet medical need **
...
several HER2-directed agents and with brain metastasis, remains dismal. **3.1.3. Main clinical studies **
...
baseline were treated with tucatinib. ***3.2. Favourable effects ***
...
Assessment report
EMA/78409/2021 Page 143/148


-----

PFS in patients with brain metastases at baseline was statistically significant improved from 5.4
...
results post-authorisation by the end of Q2 2023, which is acceptable (see PI and RMP). ***3.4. Unfavourable effects ***
...
from these cohorts will support further characterisation of tucatinib’s long-term safety profile. ***3.6. Effects Table ***
...
Assessment report
EMA/78409/2021 Page 145/148

|Effect Short Description Unit Treatment Tucatinib Control Placebo Uncertainties/ Strength of evidence Ref|Col2|Col3|Col4|Col5|Col6|Col7|
|---|---|---|---|---|---|---|
|Favourable Effects|||||||
...
Abbreviations: PFS BM: PFS in patients with brain metastases at baseline; AE: Adverse Event; SAE:
...
setting. **3.7.2. Balance of benefits and risks **
...
RMP). **3.7.3. Additional considerations on the benefit-risk balance **
