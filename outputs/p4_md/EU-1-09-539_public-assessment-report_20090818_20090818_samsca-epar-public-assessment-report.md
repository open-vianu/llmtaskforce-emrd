...
In fasted rats, exposure (C max and AUC) to tolvaptan was greater in females than in males after a single
...
Ta b l e Su mmar y o f th e ri s k mana ge m e nt p lan
...
|experience|Col2|• Warning in Section 4.6 of the SPC that tolvaptan is contraindicated during breastfeeding|
|---|---|---|
...
for V 2 over V 1 receptors in rat, dog and human in vitro, and selectivity for human V 2 receptors over
human V 1a receptors, but tolvaptan had no affinity for human V 1b receptors. Metabolites were less
...
tested showing tolvaptan to have a relatively rapid absorption, with C max and AUC increasing dosedependently, but the increases were generally not linear, possibly due to high first-pass metabolism.
The presence of food reduced C max and AUC. *In vitro* and *ex vivo* plasma protein binding were high
...
the subgroup with hyponatraemia+CHF, the tolvaptan group had a trend to lower CV
